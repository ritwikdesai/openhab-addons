...
public class SonyThingDefinition {
    ...
    private @Nullable Map<String, String> channelGroups;
    ...
    public Map<String, String> getChannelGroups() {
        final Map<String, String> localChannelGroups = channelGroups;
        return localChannelGroups == null ? new HashMap<>() : localChannelGroups;
    }
