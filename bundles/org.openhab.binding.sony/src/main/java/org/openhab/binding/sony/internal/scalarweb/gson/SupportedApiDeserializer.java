...
public class SupportedApiDeserializer implements JsonDeserializer<SupportedApi> {
    @Override
    public SupportedApi deserialize(@Nullable JsonElement je, @Nullable Type type,
        ...
        if (je instanceof JsonObject) {
            ...
            for (JsonElement elm : protElm.getAsJsonArray()) {
            ...
            for (JsonElement elm : apisElm.getAsJsonArray()) {
            ...
            if (jo.has("notifications")) {
                ...
                for (JsonElement elm : notElm.getAsJsonArray()) {
