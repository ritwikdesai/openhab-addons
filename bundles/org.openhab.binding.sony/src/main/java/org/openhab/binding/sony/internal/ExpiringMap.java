...
public class ExpiringMap<K, V> implements AutoCloseable {
     ...
     */
    public ExpiringMap(@Nullable ScheduledExecutorService scheduler, int expireTime, TimeUnit timeUnit) {
     ...
     */
    public void addExpireListener(ExpireListener<K, V> listener) {
