...
public class IrccRemoteCommands {
     ...
     */
    private IrccRemoteCommands(@Nullable Map<String, IrccRemoteCommand> cmds) {
        remoteCmds.putAll(cmds == null || cmds.size() == 0 ? getDefaultCommands() : cmds);
    }
    ...
    public static Map<String, IrccRemoteCommand> getDefaultCommands() {
        Map<String, IrccRemoteCommand> remoteCmds = new HashMap<>();
    ...
    static class IrccRemoteCommandsConverter implements Converter {
        ...
        @Override
        public boolean canConvert(@SuppressWarnings("rawtypes") @Nullable Class clazz) {
            return IrccRemoteCommands.class.equals(clazz);
        }

        @Override
        public void marshal(@Nullable Object obj, @Nullable HierarchicalStreamWriter writer,
                @Nullable MarshallingContext context) {
            throw new NotImplementedException();

        }

        @Override
        public Object unmarshal(@Nullable HierarchicalStreamReader reader, @Nullable UnmarshallingContext context) {
