...
class IrccCode {
     ...
     */
    private IrccCode(String command, String value) {
    ...
    static class IrccCodeConverter implements Converter {
        ...
        @Override
        public void marshal(@Nullable Object arg0, @Nullable HierarchicalStreamWriter arg1,
                @Nullable MarshallingContext arg2) {
            throw new NotImplementedException();
        }

        @Override
        public @Nullable Object unmarshal(@Nullable HierarchicalStreamReader reader,
