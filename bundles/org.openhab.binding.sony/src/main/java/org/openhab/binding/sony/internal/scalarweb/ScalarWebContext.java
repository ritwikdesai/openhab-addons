...
public class ScalarWebContext {
    ...
    private @Nullable TransformationService transformService;
     ...
     */
    public ScalarWebContext(Supplier<Thing> thingSupplier, ScalarWebConfig config, ScalarWebChannelTracker tracker,
            ScheduledExecutorService scheduler, SonyDynamicStateProvider stateProvider,
            @Nullable WebSocketClient webSocketClient, @Nullable TransformationService transformService,
            ScalarWebChannelMapper mapper) {
