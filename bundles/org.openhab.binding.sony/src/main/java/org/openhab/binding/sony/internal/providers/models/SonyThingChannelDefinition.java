 ...
 */
@NonNullByDefault
public class SonyThingChannelDefinition implements SonyMatcher {
    ...
    static final Comparator<SonyMatcher> COMPARATOR = Comparator
            .comparing((SonyMatcher e) -> ((SonyThingChannelDefinition) e).getChannelId());
    ...
    public boolean matches(@Nullable Object obj) {
        ...
        if (obj == null || !(obj instanceof SonyThingChannelDefinition)) {
            return false;
        }

        final SonyThingChannelDefinition other = (SonyThingChannelDefinition) obj;

        return StringUtils.equalsIgnoreCase(channelId, other.channelId)
                && StringUtils.equalsIgnoreCase(channelType, other.channelType)
                && SonyUtil.equalsIgnoreCase(properties, other.properties);
                //&& state.matches(other.state); dynamic state screws this one
    }
