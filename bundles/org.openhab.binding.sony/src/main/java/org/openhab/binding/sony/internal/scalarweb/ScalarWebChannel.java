...
public class ScalarWebChannel {
    ...
    /** The logger */
    // private Logger logger = LoggerFactory.getLogger(ScalarWebChannel.class);
     ...
     */
    public ScalarWebChannel(String service, String category, String id, String @Nullable [] paths) {
     ...
     */
    public ScalarWebChannel(Channel channel) {
     ...
     */
    public ScalarWebChannel(ChannelUID channelUID, Channel channel) {
     ...
     */
    public @Nullable String getPathPart(int idx) {
     ...
     */
    public @Nullable String removeProperty(String key) {
        Validate.notEmpty(key, "key cannot be empty");
     ...
     */
    public static String createChannelId(String id) {
        Validate.notEmpty(id, "id cannot be empty");
     ...
     * @return a non-null, non-empty channel id
     */
    public static String createChannelId(String category, String id) {
        Validate.notEmpty(id, "id cannot be empty");
