 ...
 *
 * @author Ritwik Desai - Initial contribution
 */
@NonNullByDefault
public class WiZLightingHandler extends BaseThingHandler {
    ...
    private @Nullable WiZLightingConfiguration config;

    public WiZLightingHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        ...
        config = getConfigAs(WiZLightingConfiguration.class);
